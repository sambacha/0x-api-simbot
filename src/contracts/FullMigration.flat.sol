...
contract InitialMigration {
    ...
    function deploy(address payable owner, SimpleFunctionRegistry registry, Ownable ownable) public virtual returns (ZeroEx zeroEx) {
        ...
        IBootstrap(address(zeroEx)).bootstrap(
            address(this),
            abi.encodeWithSelector(this.bootstrap.selector, owner, registry, ownable)
        );
    ...
    /// @return success Magic bytes if successful.
    function bootstrap(address owner, SimpleFunctionRegistry registry, Ownable ownable) public virtual returns (bytes4 success) {
    ...
    InitialMigration
{
    ...
    /// @param owner The owner of the contract.
    /// @return zeroEx The deployed and configured `ZeroEx` contract.
    function deploy(address payable owner) public returns (ZeroEx zeroEx) {
